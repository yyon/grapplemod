...
//        super.setRenderManager(p_i46137_1_);
    ...
    public void doRender(Entity entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
    	...
    	GL11.glEnableRescaleNormal();
    	GL11.glScaled(0.5F, 0.5F, 0.5F);
    	GL11.glRotated(-this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
    	GL11.glRotated(this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
        this.bindTexture(TextureMap.locationBlocksTexture);
        this.field_177083_e.renderItemModel(this.func_177082_d(entity));
        GL11.gldisableRescaleNormal();
        GL11.glPopMatrix();
