...
public class ClientSetup {
	...
	public void registerPropertyOverride() {
		...
		ItemProperties.register(CommonSetup.grapplingHookItem, new ResourceLocation("double"), new ItemPropertyFunction() {
			public float call(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed) {
				return CommonSetup.grapplingHookItem.getPropertyDouble(stack, world, entity) ? 1 : 0;
			}
		});
		ItemProperties.register(CommonSetup.grapplingHookItem, new ResourceLocation("motor"), new ItemPropertyFunction() {
			public float call(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed) {
				return CommonSetup.grapplingHookItem.getPropertyMotor(stack, world, entity) ? 1 : 0;
			}
		});
		ItemProperties.register(CommonSetup.grapplingHookItem, new ResourceLocation("smart"), new ItemPropertyFunction() {
			public float call(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed) {
				return CommonSetup.grapplingHookItem.getPropertySmart(stack, world, entity) ? 1 : 0;
			}
		});
		ItemProperties.register(CommonSetup.grapplingHookItem, new ResourceLocation("enderstaff"), new ItemPropertyFunction() {
			public float call(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed) {
				return CommonSetup.grapplingHookItem.getPropertyEnderstaff(stack, world, entity) ? 1 : 0;
			}
		});
		ItemProperties.register(CommonSetup.grapplingHookItem, new ResourceLocation("magnet"), new ItemPropertyFunction() {
			public float call(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed) {
				return CommonSetup.grapplingHookItem.getPropertyMagnet(stack, world, entity) ? 1 : 0;
			}
		});
		ItemProperties.register(CommonSetup.grapplingHookItem, new ResourceLocation("attached"), new ItemPropertyFunction() {
			public float call(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed) {
		...
		ItemProperties.register(CommonSetup.forcefieldItem, new ResourceLocation("attached"), new ItemPropertyFunction() {
			public float call(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed) {
				if (entity == null) {return 0;}
